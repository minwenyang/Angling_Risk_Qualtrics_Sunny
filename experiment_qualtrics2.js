...
var start_test_block = {
	...
	timing_response: 180000,
	text: '<div class = centerbox><p class = center-block-text>Done with practice! We will now start the test tournaments. There will be two tournaments, each with 5 rounds of fishing.</p><p class = center-block-text>Press <strong>enter</strong> to begin the test.</p></div>',
	cont_key: [13],
	timing_post_trial: 1000,
	on_finish: function() {
		tournament_bank = 0
...
for (b = 0; b < practiceblocks.length; b++) {
	...
	var tournament_intro_block_practice = {
		type: 'poldrack-text',
		text: '<div class = centerbox><p class = block-text>You will now start a practice tournament. The release rule is <span style="color:red">' + release + '</span>, which means ' +
			release_rule +
			'.</p><p class = center-block-text>Press <strong>enter</strong> to begin.</p></div>',
		cont_key: [13],
		timing_response: 180000,
...
total_pt = total_points

var end_block = {
	type: 'poldrack-text',
	text: '<div class = centerbox><p class = center-block-text>Thanks for completing this task! You earned ' + total_pt + ' points in total. </p><p class = center-block-text>Press <strong>enter</strong> to begin.</p></div>',
	cont_key: [13],
	data: {
		trial_id: "end",
